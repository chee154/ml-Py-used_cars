# ml-Py-used_cars
Short Summary: Building various **Classification** and **Regression** models on used cars in the US to predict various nominal attributes. Additionally, we also built **Clustering** and **Collaborative Filtering** models using Lending Tree data that aism to predict if a loan will be paid off on time or not.
